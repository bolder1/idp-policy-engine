...
export const PERSONAS: Persona[] = [
  {
    ...
    /* The list, not Templates: the Templates page only shows templates, and a
       day-zero admin needs the New policy action and the always-on default. */
    landing: 'policies',
    depth: 'none',
    needs: [
      {
      ...
      },
      {
        ...
        tab: 'templates',
        met: true,
        note: 'New policy offers the shipped templates on the empty board, with a preview of the rules before they are applied.',
      },
      {
      ...
      },
      {
        ...
        tab: 'zones',
        met: true,
        note: 'The policy list, Zones, Device profiles and External hooks have empty states with the action that fills them.',
      },
    ],
  },
  {
    ...
    needs: [
      {
        ...
        tab: 'policies',
        met: true,
        note: 'A status pill per row: Draft, Active or Inactive.',
      },
      {
        what: 'Be told when a policy cannot work',
        tab: 'policies',
        met: true,
        note: 'A policy with no applications stays a draft, and Turn on names what is missing.',
      },
      {
        what: 'Find what is protected by nothing',
        tab: 'policies',
        met: false,
        note: 'Not built in Lite. The Coverage tab is behind the coverage flag, which Lite turns off.',
      },
      {
        what: 'Reuse one policy across many apps',
        tab: 'policies',
        met: true,
        note: 'Assign apps takes many, and a tip beside an app names any other live policy that already decides it.',
      },
      {
